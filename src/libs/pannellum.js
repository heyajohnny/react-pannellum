  ...
  function Viewer(container, initialConfig) {
    ...
    function onImageLoad() {
      ...
      if (!listenersAdded) {
        ...
        window.addEventListener('msfullscreenchange', onFullScreenChange, false);
        ...
        window.addEventListener('mouseleave', onDocumentMouseUp, false);
        if (document.documentElement.style.pointerAction === '' &&
          ...
          window.addEventListener('pointerleave', onDocumentPointerUp, false);
        } else {
    ...
    function mouseEventToCoords(event, returnPixels = false) {
      ...
      return returnPixels && pixels !== null ? [pitch, yaw, distanceInMeter, config, pixels] : [pitch, yaw, distanceInMeter, config];
    }
    ...
    this.destroy = function () {
      ...
      if (listenersAdded) {
        ...
        window.removeEventListener("keydown", onDocumentKeyPress, false);
